...
def main(): 
    ...
    cat = 'conv'
    black_c,white_c = make_concepts(black_df=blk_df,white_df=whit_df,my_loader=ds_cls,transforms=val_transform,conf=conf)
    if cat =='relu': 
    ...
    tcav_scores_w_random = mytcav.interpret(inputs=zebra_tensors,
                                            ...
                                            processes=0,
                                            target=(1,),
                                            n_steps=2,additional_forward_args='demo'
                                        )
