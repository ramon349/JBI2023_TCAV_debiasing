...
from monai.transforms.utils import get_largest_connected_component_mask,generate_spatial_bounding_box
import numpy as np 
...
class SCropd(MapTransform):
    def __init__(self, keys=None,label_key=None,allow_missing_keys = False,update_meta=False) -> None:
